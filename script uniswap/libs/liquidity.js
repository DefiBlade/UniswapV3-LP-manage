...
const {
  Pool,
  Position,
  nearestUsableTick, NonfungiblePositionManager
...
const { fromReadableAmount } = require( './conversion.js')
 ...
 async function constructPosition(
  ...
  console.log(configuredPool.tickSpacing)
  console.log("tickSpacing ... ")
...
module.exports = { addLiquidity,removeLiquidity,getPositionIds,getPositionInfo,getTokenTransferApproval,constructPosition,mintPosition }
